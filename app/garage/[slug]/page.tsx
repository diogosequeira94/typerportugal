...
const builds = {
  fk8: {
    code: "FK8", name: "Civic Type R FK8", title: "O PADRÃO BRANCO.", image: "/cars/fk8.jpg", owner: "Membro fundador", handle: "@typergarageportugal", year: "2018", colour: "Branco Championship", power: "320 PS", torque: "400 Nm", status: "Configuração de fábrica", note: "Um FK8 imaculado, anterior ao facelift, mantido exatamente como a Honda o idealizou — o ponto de partida para um projeto que dispensa apresentações.",
  ...
  fk2: {
    code: "FK2", name: "Civic Type R FK2", title: "A PRIMEIRA ERA TURBO.", image: "/cars/fk2.jpg", owner: "Destaque da garagem", handle: "@typergarageportugal", year: "2016", colour: "Branco Championship", power: "310 PS", torque: "400 Nm", status: "Destaque da comunidade", note: "O Type R turbo, puro e determinado, que redefiniu o ritmo para uma nova era de desempenho Civic.",
...
export default async function BuildPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="profile-page">
    ...
    <section className="profile-content">
      <aside className="owner-card"><p className="eyebrow"><span /> Proprietário</p><h2>{build.owner}</h2><p>Parte da comunidade Type R Garage Portugal.</p><a href="https://instagram.com/" target="_blank" rel="noreferrer"><b>◎</b> Instagram <span>{build.handle}</span></a><a href="https://facebook.com/" target="_blank" rel="noreferrer"><b>f</b> Facebook <span>Type R Garage PT</span></a><div className="side-gallery"><p className="eyebrow"><span /> Galeria do proprietário</p><figure style={{ backgroundImage: `url(${build.image})` }}><figcaption>Abrir galeria</figcaption></figure></div><div className="side-sound"><p className="eyebrow"><span /> Som do escape</p><b>▶</b><div><strong>Ouvir o carro</strong><span>A aguardar vídeo do proprietário</span></div></div></aside>
